<?php
    ...
    if(isset($_GET['btnlog'])){
        ...
        $sql = mysqli_query($conexao, "select u.*, n.nome as nivel from tbl_usuario as u, tbl_niveis as n where u.usuario = '$login' and u.senha = '$encryptSenha' and u.status = 1 and n.id = u.idNivel");
        
        if($rsNivel = mysqli_fetch_array($sql)){
            $_SESSION['nivel'] = utf8_encode($rsNivel['nivel']);
        }
                    ...
                    <ul class="categoria">
                        <li class="categoria-item">
                            ...
                            <ul class="subcategoria">
                                <li><a href="subcategoria.php?idSubcategoria=<?php echo(utf8_encode($rsSubcategoria['id'])) ?>"><?php echo(utf8_encode($rsSubcategoria['nome']))?></a></li>
                            </ul>
                            <?php } ?>
                            <?php } ?>
                        </li>
                    ...
                    <div class="catalogo">
                        ...
                        <?php
                            if(isset($_GET['txtsearch'])){
                                ...
                                $sql = "SELECT * FROM tbl_produtos WHERE nome LIKE '".$pesquisa."'";
                            }else{
                        ...
                        <div class="catalogo-item">
                            ...
                            <article style="text-align: left;">
                                ...
                                <p>Preço: <?php echo(utf8_encode($rsProdutos['preco'])) ?> </p>
                                <p>Descrição: <?php echo(utf8_encode($rsProdutos['descricao'])) ?> </p>
                                <p style="text-align: right;" id="detalhes" onclick="modal(<?php echo(utf8_encode($rsProdutos['id'])) ?>)">Detalhes: </p>
                            </article>
                        </div>
                        <?php } ?>
                    </div>
